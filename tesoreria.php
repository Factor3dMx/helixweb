...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">MANEJO DE</h1>
            <h1 class="black">TESORERÍA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Eficiencia Operativa — Optimiza cada Peso de tu Empresa</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Maximiza el rendimiento de tus excedentes de flujo de caja sin comprometer la liquidez. Nuestra gestión de tesorería corporativa permite que el capital operativo de tu empresa trabaje activamente, reduciendo costos financieros y mejorando la rentabilidad de corto plazo bajo un marco de alta seguridad.
            </p>
            <a href="#" class="learn-more">
                Optimizar mi tesorería <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
