...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">SEGURO</h1>
            <h1 class="black">UNIT LINKED</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Protección e Inversión — Eficiencia Sucesoria de Alto Nivel</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Combine las ventajas de un seguro de vida con la flexibilidad de un portafolio de inversión. Los seguros Unit Linked le permiten gestionar sus activos con diferimiento fiscal y una transmisión de patrimonio ágil, asegurando que su familia esté protegida mientras su capital continúa creciendo bajo una estructura legalmente robusta.
            </p>
            <a href="#" class="learn-more">
                Explorar ventajas fiscales <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
