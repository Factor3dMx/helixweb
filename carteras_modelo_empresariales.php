...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">CARTERAS</h1>
            <h1 class="black">MODELO</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Gestión Institucional — Portafolios Basados en Objetivos</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Implementa portafolios diversificados diseñados bajo rigurosos estándares de análisis financiero. Nuestras carteras modelo para personas morales permiten a tu empresa delegar la gestión técnica a expertos, asegurando que el capital social se mantenga optimizado según el nivel de riesgo y los horizontes de inversión definidos por la junta directiva.
            </p>
            <a href="#" class="learn-more">
                Consultar modelos de inversión <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
