...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">PERSONAL</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Liquidez Revolvente — Agilidad para Oportunidades Únicas</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Acceda a líneas de crédito personales y revolventes diseñadas para ofrecerle libertad absoluta. Ya sea para capitalizar una oportunidad de inversión imprevista o gestionar necesidades de flujo inmediato, nuestras soluciones le brindan disponibilidad de efectivo con procesos de disposición ágiles y sencillos.
            </p>
            <a href="#" class="learn-more">
                Solicitar línea personal <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
