...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">SMART</h1>
            <h1 class="black">CASH</h1>
        </div>

        <div class="info-box">
            <div class="info-header">
                <h2>Liquidez Inteligente — Haz que tu Efectivo Trabaje 24/7</h2>
            </div>
            
            <hr class="separator">

            <p class="description">
                No dejes que tu dinero pierda valor en el banco. Smart Cash es la solución para tu capital de corto plazo, ofreciendo rendimientos competitivos con disponibilidad inmediata. Ideal para mantener tu flujo de caja operativo rindiendo bajo estrategias de bajo riesgo mientras esperas tu próxima gran oportunidad de inversión.
            </p>

            <a href="#" class="learn-more">
                Conocer más sobre Smart Cash <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
