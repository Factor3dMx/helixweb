    ...
    <div class="content">
        ...
        <div class="info-box">
            <div class="info-header">
                <h2>Sin Fronteras — Acceso Directo a los Gigantes del Mundo</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Expande tus horizontes invirtiendo en las compañías que lideran la innovación global. Al integrar acciones internacionales, diversificas tu riesgo geográfico y posicionas tu capital en las economías más robustas, aprovechando sectores que no están disponibles en el mercado local.
            </p>
            <a href="#" class="learn-more">
                Explorar mercados globales <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
