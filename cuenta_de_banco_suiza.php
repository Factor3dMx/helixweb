...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">CUENTA</h1>
            <h1 class="black">SUIZA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Privacidad y Fortaleza — El Refugio Seguro de su Patrimonio</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Establezca su base financiera en la jurisdicción más estable del planeta. Una cuenta bancaria en Suiza le ofrece no solo prestigio, sino una protección inigualable para su capital, con acceso a servicios de banca privada, multidivisa y la confidencialidad que caracteriza al sistema financiero helvético.
            </p>
            <a href="#" class="learn-more">
                Solicitar apertura de cuenta <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
