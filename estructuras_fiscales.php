...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">EFICIENCIA</h1>
            <h1 class="black">FISCAL</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Optimización Impositiva — Maximizando tu Retorno Neto</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Lo que importa no es cuánto ganas, sino cuánto conservas. Analizamos y diseñamos estructuras fiscales legales que minimicen el impacto de los impuestos sobre tus rendimientos, asegurando que tu patrimonio crezca de manera eficiente y en total cumplimiento con las normativas locales e internacionales.
            </p>
            <a href="#" class="learn-more">
                Ver estrategias fiscales <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
