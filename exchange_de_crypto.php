...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">CRYPTO</h1>
            <h1 class="black">EXCHANGE</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Activos Digitales — Custodia y Operación de Grado Bancario</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Integre las criptomonedas a su patrimonio con la seguridad de un ecosistema regulado en Suiza. Nuestro exchange permite la compra, venta y custodia de activos digitales bajo los más estrictos estándares de ciberseguridad, uniendo el mundo de las finanzas descentralizadas con la solidez bancaria tradicional.
            </p>
            <a href="#" class="learn-more">
                Explorar activos digitales <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
