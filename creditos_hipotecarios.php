...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">HIPOTECARIO</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Patrimonio Inmobiliario — Financiamiento con Visión Estratégica</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Adquiera su propiedad ideal con esquemas de financiamiento diseñados a la medida de su flujo de efectivo. Nos especializamos en créditos hipotecarios de alto valor con tasas competitivas y plazos flexibles, permitiéndole consolidar su patrimonio residencial o comercial sin comprometer su liquidez operativa.
            </p>
            <a href="#" class="learn-more">
                Consultar planes hipotecarios <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
