...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">PERFIL DE</h1>
            <h1 class="black">RIESGO</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Tu Tolerancia, Tu Estrategia — Equilibrio entre Paz y Rendimiento</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Identificar tu ADN financiero es el primer paso para una inversión exitosa. Analizamos tu tolerancia a la volatilidad y tu capacidad financiera para diseñar una estrategia que te permita dormir tranquilo mientras tu patrimonio trabaja, asegurando que tus inversiones siempre estén alineadas con tu zona de confort.
            </p>
            <a href="#" class="learn-more">
                Descubrir mi perfil <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
