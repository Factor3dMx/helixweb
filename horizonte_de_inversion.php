...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">METAS Y</h1>
            <h1 class="black">HORIZONTES</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Propósito en el Tiempo — Alineando Inversiones con Sueños</h2>
            </div>
            <hr class="separator">
            <p class="description">
                El dinero es una herramienta para alcanzar metas. Ya sea que busques la jubilación, la educación de tus hijos o la compra de una propiedad, definimos el horizonte temporal adecuado para cada objetivo, optimizando el interés compuesto y reduciendo la incertidumbre del corto plazo para llegar a tu destino.
            </p>
            <a href="#" class="learn-more">
                Definir mis objetivos <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
