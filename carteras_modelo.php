    ...
    <div class="content">
        ...
        <div class="info-box">
            <div class="info-header">
                <h2>Gestión Experta — Portafolios Diseñados por Especialistas</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Elimina la incertidumbre con portafolios optimizados que se ajustan a tu perfil de riesgo y objetivos financieros. Nuestras Carteras Modelo utilizan algoritmos avanzados y análisis experto para balancear activos automáticamente, asegurando que tu dinero siempre esté en la mejor posición estratégica.
            </p>
            <a href="#" class="learn-more">
                Elegir mi cartera ideal <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
