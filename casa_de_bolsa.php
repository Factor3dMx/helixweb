...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">ESTRATEGIAS</h1>
            <h1 class="black">FINANCIERAS</h1>
        </div>

        <div class="info-box">
            <div class="info-header">
                <h2>Estrategias de Preservación de Capital — Un Salto en Rendimiento Global</h2>
            ...
            <p class="description">
                Optimiza tu patrimonio más allá de la gestión tradicional. Mediante el uso de estructuras en mercados internacionales (EUA y Suiza), hemos automatizado la diversificación de activos, gestión de divisas y estrategias fiscales eficientes, resultando en un incremento sustancial en la seguridad patrimonial y el flujo de caja operativo.
            </p>

            <a href="#" class="learn-more">
                Conocer más sobre Wealth Management <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
