...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">CONSTRUCCIÓN</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>De los Planos a la Realidad — Capital para Desarrollar</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Financiamos la materialización de sus proyectos arquitectónicos. Nuestras líneas de crédito para construcción ofrecen ministraciones programadas según el avance de obra, brindándole el soporte financiero necesario para edificar desde residencias privadas hasta desarrollos comerciales con total control presupuestario.
            </p>
            <a href="#" class="learn-more">
                Financiar mi proyecto <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
