...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">FOREX</h1>
            <h1 class="black">SUIZO</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Precisión y Liquidez — Ejecución en el Hub Financiero del Mundo</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Opere en el mercado de divisas con la infraestructura tecnológica de las instituciones suizas. Acceda a spreads institucionales y una ejecución ultra rápida en los principales pares de divisas, respaldado por la estabilidad y transparencia que solo la jurisdicción helvética puede ofrecer a los inversionistas globales.
            </p>
            <a href="#" class="learn-more">
                Ver condiciones de trading <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
