...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">FONDOS DE</h1>
            <h1 class="black">INVERSIÓN</h1>
        </div>

        <div class="info-box">
            <div class="info-header">
                <h2>Gestión Colectiva — Diversificación Inteligente en Mercados Globales</h2>
            </div>
            
            <hr class="separator">

            <p class="description">
                Participa en un ecosistema de inversión diversificado gestionado por expertos en tecnología financiera. Nuestros fondos combinan el análisis de activos alternativos con la estabilidad de los mercados tradicionales, permitiéndote escalar tu capital con una exposición de riesgo controlada y transparencia total en cada operación.
            </p>

            <a href="#" class="learn-more">
                Conocer más sobre Fondos <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
