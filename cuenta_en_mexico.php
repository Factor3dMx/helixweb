...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">MÉXICO</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Solidez Local — Potencia tu Patrimonio en Casa</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Aprovecha las ventajas fiscales y la regulación del sistema financiero mexicano. Nuestra cuenta local te brinda acceso directo a la Bolsa Mexicana de Valores y al SIC, permitiéndote gestionar tus activos con la confianza de instituciones reguladas y una atención personalizada en tu idioma.
            </p>
            <a href="#" class="learn-more">
                Abrir cuenta en México <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
