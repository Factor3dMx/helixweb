...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">RENTA</h1>
            <h1 class="black">FIJA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Certidumbre y Estabilidad — Planifica tu Futuro con Precisión</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Desde liquidez inmediata para tus metas de corto plazo hasta estrategias de preservación de riqueza a largo plazo. La renta fija es el pilar de un portafolio equilibrado, ofreciendo flujos de efectivo constantes y la tranquilidad de conocer tus rendimientos de antemano bajo un esquema de bajo riesgo.
            </p>
            <a href="#" class="learn-more">
                Ver planes de rendimiento <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
