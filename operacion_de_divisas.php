...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">GESTIÓN</h1>
            <h1 class="black">MONETARIA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Movilidad de Capital — Transferencias y Cambio de Divisas</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Gestione sus flujos internacionales con agilidad y costos competitivos. Realice transferencias transfronterizas seguras y operaciones de cambio en tiempo real entre las principales monedas del mundo (CHF, USD, EUR, GBP), asegurando que su liquidez esté siempre donde usted la necesita.
            </p>
            <a href="#" class="learn-more">
                Gestionar mis divisas <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
