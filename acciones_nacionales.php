...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">ACCIONES</h1>
            <h1 class="black">NACIONALES</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Impulsa el Crecimiento Local — Invierte en el Éxito de tu País</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Participa en la propiedad de las empresas más sólidas del mercado interno. Las acciones nacionales ofrecen una vía directa para capitalizar el crecimiento económico local, permitiéndote construir riqueza a través de la apreciación de capital y la distribución de dividendos en tu propia moneda.
            </p>
            <a href="#" class="learn-more">
                Ver oportunidades locales <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
