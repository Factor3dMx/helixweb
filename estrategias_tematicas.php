...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">TEMÁTICAS</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Invierte en el Futuro — Capitaliza las Megatendencias Globales</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Más allá de los sectores tradicionales, las estrategias temáticas te permiten invertir en las fuerzas que están transformando el mundo: desde Inteligencia Artificial y Ciberseguridad hasta Energías Limpias. Posiciona tu capital en los motores de crecimiento del mañana con un enfoque de alta convicción.
            </p>
            <a href="#" class="learn-more">
                Explorar temas de inversión <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
