...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">LÍNEAS DE</h1>
            <h1 class="black">PIGNORACIÓN</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Liquidez Dinámica — Haz que tus Inversiones te den Crédito</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Obtén financiamiento inmediato utilizando tu portafolio de inversión como garantía. Con la pignoración, accedes a capital para proyectos personales o nuevas oportunidades sin necesidad de liquidar tus posiciones, manteniendo intacta tu estrategia de inversión y tus rendimientos esperados.
            </p>
            <a href="#" class="learn-more">
                Consultar sobre líneas de crédito <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
