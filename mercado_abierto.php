...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">BANCA</h1>
            <h1 class="black">PRIVADA MAE</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Operaciones de Capital — Fusiones y Mercado Abierto</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Acompañamiento especializado en transacciones de alta complejidad. Desde la participación en el Mercado Abierto Electrónico hasta asesoría en Fusiones y Adquisiciones (M&A), conectamos a su empresa con las oportunidades estratégicas que maximizan el valor de su capital y su posicionamiento en el mercado global.
            </p>
            <a href="#" class="learn-more">
                Ver servicios de banca de inversión <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
