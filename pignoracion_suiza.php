...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">LOMBARD</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Liquidez Inteligente — Pignore su Portafolio en Suiza</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Optimice su flujo de caja sin interrumpir su estrategia de inversión. Utilice sus activos custodiados en Suiza como garantía para acceder a líneas de crédito inmediatas. Es la solución ideal para obtener liquidez estratégica mientras su patrimonio continúa creciendo y generando rendimientos.
            </p>
            <a href="#" class="learn-more">
                Consultar sobre pignoración <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
