...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">CRÉDITO</h1>
            <h1 class="black">REVOLVENTE</h1>
        </div>

        <div class="info-box">
            <div class="info-header">
                <h2>Liquidez Dinámica — Tu Capital Siempre Disponible</h2>
            </div>
            
            <hr class="separator">

            <p class="description">
                La herramienta definitiva para la gestión de flujo de caja. Con nuestra línea de crédito revolvente, dispones de fondos de manera inmediata, los pagas y vuelves a utilizarlos según tus necesidades operativas o de inversión. Mantén la agilidad financiera para capitalizar oportunidades de mercado sin esperas ni trámites adicionales.
            </p>

            <a href="#" class="learn-more">
                Activar línea de liquidez <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
