...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">MERCADOS</h1>
            <h1 class="black">GLOBALES</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Acceso Universal — Invierta en las Principales Bolsas del Mundo</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Desde su cuenta en Suiza, acceda a una arquitectura abierta que le permite invertir en acciones, ETFs y bonos en cualquier mercado global. Diversifique su portafolio sin fronteras, aprovechando una plataforma única para gestionar todos sus activos internacionales con eficiencia y control total.
            </p>
            <a href="#" class="learn-more">
                Abrir puerta al mundo <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
