...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">INVERSIÓN</h1>
            <h1 class="black">PATRIMONIAL</h1>
        </div>

        <div class="info-box">
            <div class="info-header">
                <h2>Crecimiento Individual — Potencia tu Capital con Estrategias de Élite</h2>
            </div>
            
            <hr class="separator">

            <p class="description">
                Diseñamos portafolios a la medida para inversionistas que buscan rentabilidad y seguridad. A través de nuestra arquitectura abierta, accedes a instrumentos financieros que antes estaban reservados solo para grandes capitales, permitiéndote diversificar en activos digitales y tradicionales bajo un esquema de gestión profesional.
            </p>

            <a href="#" class="learn-more">
                Conocer más sobre Inversión Individual <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
