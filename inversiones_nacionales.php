...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">INVERSIONES</h1>
            <h1 class="black">CORPORATIVAS</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Estrategia Global — Diversificación Multimercado para Empresas</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Fortalece el balance general de tu organización con acceso a portafolios en México y los mercados globales. Desde bonos corporativos locales hasta activos en dólares, diseñamos una estrategia de inversión que protege el capital social contra la inflación y la volatilidad cambiaria.
            </p>
            <a href="#" class="learn-more">
                Ver opciones de inversión <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
