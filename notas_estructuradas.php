...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">NOTAS</h1>
            <h1 class="black">ESTRUCTURADAS</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Arquitectura Financiera — Rendimiento con Protección de Capital</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Diseñadas para inversionistas que buscan lo mejor de dos mundos: la seguridad de la renta fija y el potencial de la renta variable. Nuestras notas estructuradas ofrecen soluciones a medida con barreras de protección, permitiéndote obtener rendimientos superiores incluso en mercados laterales.
            </p>
            <a href="#" class="learn-more">
                Descubrir soluciones a medida <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
