...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">PIGNORACIÓN</h1>
            <h1 class="black">CORPORATIVA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Liquidez Sin Desinversión — Financia tu Crecimiento con Activos</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Obtén líneas de crédito competitivas utilizando los activos financieros de tu empresa como garantía. La pignoración corporativa te permite acceder a liquidez inmediata para proyectos de expansión, compra de maquinaria o capital de trabajo, manteniendo intacta tu estrategia de inversión y tus rendimientos de largo plazo.
            </p>
            <a href="#" class="learn-more">
                Solicitar línea de crédito <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
