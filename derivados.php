...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">DIVISAS Y</h1>
            <h1 class="black">DERIVADOS</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Blindaje Cambiario — Cobertura y Pagos Internacionales</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Protege tus márgenes operativos frente a las fluctuaciones del tipo de cambio. Ofrecemos soluciones avanzadas en FX Payments para pagos a proveedores globales y estrategias de Derivados (Forwards y Opciones) para fijar costos futuros y asegurar la certidumbre financiera de tu operación.
            </p>
            <a href="#" class="learn-more">
                Cotizar cobertura cambiaria <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
