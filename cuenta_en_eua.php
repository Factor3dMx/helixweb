...
<section class="slider">
    <div class="content">
        <div class="title-group">
            ...
            <h1 class="black">USA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Alcance Global — Diversificación y Custodia Internacional</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Protege tu patrimonio bajo la jurisdicción de los Estados Unidos. Accede a una arquitectura abierta de inversión con custodia internacional, mayor liquidez y una exposición directa al dólar. Es la herramienta definitiva para quienes buscan seguridad jurídica y el máximo abanico de activos globales.
            </p>
            <a href="#" class="learn-more">
                Beneficios de invertir en EUA <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
