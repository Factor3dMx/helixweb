...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">PLANEACIÓN</h1>
            <h1 class="black">ESTRATÉGICA</h1>
        </div>
        <div class="info-box">
            <div class="info-header">
                <h2>Hoja de Ruta Patrimonial — El Mapa de tu Libertad Financiera</h2>
            </div>
            <hr class="separator">
            <p class="description">
                Una inversión sin plan es solo una apuesta. Nuestra planeación estratégica integra todos tus activos, pasivos y metas en un plan maestro integral. Adaptamos tu estrategia ante cambios de vida o de mercado, garantizando que siempre tengas el control absoluto de tu futuro financiero.
            </p>
            <a href="#" class="learn-more">
                Crear mi plan maestro <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>s
