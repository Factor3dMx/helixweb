...
<section class="slider">
    <div class="content">
        <div class="title-group">
            <h1 class="thin">PATRIMONIO</h1>
            <h1 class="black">DIVISAS</h1>
        </div>

        <div class="info-box">
            <div class="info-header">
                <h2>Estrategia Multimoneda — Protege y Maximiza tu Riqueza</h2>
            </div>
            
            <hr class="separator">

            <p class="description">
                El dominio de las divisas es la clave para una salud financiera global. Diseña estrategias personalizadas para cubrir compromisos en moneda extranjera o capitalizar la fortaleza de mercados internacionales. No solo cambies dinero; utiliza las divisas como un activo estratégico para blindar tu capital contra la devaluación y construir un legado sólido en las economías más fuertes del mundo.
            </p>

            <a href="#" class="learn-more">
                Diseñar mi estrategia de inversión <span class="arrow">›</span>
            </a>
        </div>
    </div>
</section>
